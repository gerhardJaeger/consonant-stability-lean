...
d <- read_tsv("../families/Austronesian/series_counts.tsv")

tree <- read.nexus("../families/Austronesian/phylogeny/grayetal2009.summary.trees") %>% multi2di()

conversion <- read_csv("../families/Austronesian/phylogeny/austronesian_conversion.csv")
...
# mu     2.51    0.00 0.07  2.37  2.46  2.51  2.55  2.65  3335    1
# sigma  0.65    0.00 0.05  0.56  0.61  0.65  0.68  0.76  3979    1
# lp__  -5.29    0.02 0.97 -7.88 -5.68 -4.97 -4.59 -4.34  1912    1
...
saveRDS(fit_ou, "austronesian_ou.rds")

# print(fit_ou, pars = c("mu", "sigma", "lambda", "lp__"))
#           mean se_mean    sd    2.5%     25%     50%     75%   97.5% n_eff Rhat
# mu        2.50    0.00  0.08    2.36    2.45    2.50    2.55    2.65   946 1.00
# sigma     8.58    0.05  1.65    5.93    7.40    8.39    9.55   12.37   921 1.01
# lambda   91.04    1.31 39.90   38.42   63.39   82.59  109.05  191.78   924 1.01
# lp__   -119.03    0.21  9.29 -138.73 -125.05 -118.48 -112.60 -102.50  1962 1.00
