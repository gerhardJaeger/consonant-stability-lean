...
tree <- read.nexus("data/families/Austronesian/phylogeny/grayetal2009.summary.trees") %>% multi2di()

conversion <- read_csv("data/families/Austronesian/phylogeny/austronesian_conversion.csv")
