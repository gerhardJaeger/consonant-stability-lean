...
d <- read_tsv("../families/Pama-Nyungan/series_counts.tsv")

tree <- read.nexus("../families/Pama-Nyungan/phylogeny/bouckaertetal2018.txt") %>% multi2di()

conversion <- read_csv("../families/Pama-Nyungan/phylogeny/PN_conversion.csv")
