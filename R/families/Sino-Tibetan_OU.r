...
tree <- read.nexus("data/families/Sino-Tibetan/phylogeny/Zhangetal2019.MCC.tree") %>% multi2di()

conversion <- read_csv("data/families/Sino-Tibetan/phylogeny/Zhang_ST_conversion.csv")
