...
fam <- "data/families/Turkic/"
d <- read_tsv("data/series_counts.tsv")

tree <- read.nexus(str_c(fam, "phylogeny/savelyevetal2020_turkic_AnnotatedTree.trees")) %>%
    multi2di()

conversion <- read_csv(str_c(fam, "phylogeny/Turkic_conversion.csv"))
